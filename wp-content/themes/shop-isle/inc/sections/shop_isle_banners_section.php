                ...
                if (! empty($shop_isle_banners_decoded)) :
                    ...
                    foreach ($shop_isle_banners_decoded as $shop_isle_banner) :
                        ...
                        if (! empty($shop_isle_banner->image_url)) {
                            ...
                            echo '<div class="visible-mobile">
							<img class="img-responsive center-block" src="'.$base_url.'/wp-content/uploads/2017/05/Aboutus_mobile_2017.jpg" /> <!--Mobile-->
							</div>';
                            
                            echo '<div class="hidden-mobile">
							<img class="img-responsive center-block" src="'.$base_url.'/wp-content/uploads/2017/05/Home_wreare-cropped.jpg" />   <!--Non-mobile-->
							</div>';
